...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div ref={containerRef} className="h-[85vh]" style={{ position: "relative" }}>
      <motion.div
        className="sticky top-24 md:top-32 rounded-[40px] sm:rounded-[50px] md:rounded-[60px] p-4 sm:p-6 md:p-8"
        style={{
          top: `${index * 28}px`,
          scale,
          background: "#0C0C0C",
        ...
        <div className="flex items-center justify-between gap-4 mb-6 sm:mb-8 flex-wrap">
          <div className="flex items-center gap-4 sm:gap-6">
            <span
              ...
              style={{ color: "#0C0C0C", fontSize: "clamp(3rem, 10vw, 140px)", WebkitTextStroke: "1px #D7E2EA" }}
            >
              {project.number}
            </span>
